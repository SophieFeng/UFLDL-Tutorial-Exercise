...
lambda = 3e-3;       % weight decay parameter       1
...
mnistData   = loadMNISTImages('../../0.Dependencies/mnist/train-images-idx3-ubyte');
mnistLabels = loadMNISTLabels('../../0.Dependencies/mnist/train-labels-idx1-ubyte');
